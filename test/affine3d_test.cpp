...
int main(int argc, char* argv[])
{
    ...
    a6.translate(6.f, 8.f, 5.f).shear_x(0.3 * ktm::pi<float>, 0.7 * ktm::pi<float>).scale(1.f, 2.f, 2.f);
    a6 >> a6_mat;
    a5.translate(2.f, 2.f, 5.f).rotate_axis(0.7f * ktm::pi<float>, { 0.f, 0.8f, 0.6f }).scale(4.f, 4.f, 2.f) << a6_mat;
