...
int main(int argc, char* argv[])
{
    ...
    ktm::faffine2d a4 {};
    a4.translate(2.f, 2.f).rotate(0.7f * ktm::pi<float>).shear_y(0.3 * ktm::pi<float>).scale(1.f, 2.f);
    ktm::fmat3x3 a4_mat = ktm::translate2d(ktm::fvec2 { 2.f, 2.f }) * ktm::rotate2d(0.7f * ktm::pi<float>) *
                          ktm::shear2d_y(0.3f * ktm::pi<float>) * ktm::scale2d(ktm::fvec2 { 1.f, 2.f });
    ...
    std::cout << affine_factor.get_translate() * affine_factor.get_rotate() * affine_factor.get_shear() *
                     affine_factor.get_scale() * a4_vec
              << std::endl;
    ...
    a6.translate(6.f, -8.f).shear_x(0.32f * ktm::pi<float>).scale(2.f, -2.f);
    a6 >> a6_mat;
    a5.translate(2.f, 5.f).rotate(0.7f * ktm::pi<float>).scale(4.f, 2.f) << a6_mat << a6;
