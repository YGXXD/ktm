...
int main(int argc, char* argv[])
{
    ...
    TEST_EQUAL(ktm::length(ktm::fvec3(3.0f, 4.0f, 5.0f)), 7.071068f);
    TEST_EQUAL(ktm::length(ktm::fvec4(1.0f, 2.0f, 2.0f, 1.0f)), 3.162278f);
    ...
    TEST_EQUAL(ktm::normalize(ktm::fvec2(1.0f, 1.0f)), ktm::fvec2(0.707107f, 0.707107f));
    TEST_EQUAL(ktm::normalize(ktm::fvec2(2.0f, 2.0f)), ktm::fvec2(0.707107f, 0.707107f));
    TEST_EQUAL(ktm::normalize(ktm::fvec2(3.0f, 3.0f)), ktm::fvec2(0.707107f, 0.707107f));
    ...
    TEST_EQUAL_FAST(ktm::fast::normalize(ktm::fvec2(1.0f, 1.0f)), ktm::fvec2(0.707107f, 0.707107f));
    TEST_EQUAL_FAST(ktm::fast::normalize(ktm::fvec2(2.0f, 2.0f)), ktm::fvec2(0.707107f, 0.707107f));
    TEST_EQUAL_FAST(ktm::fast::normalize(ktm::fvec2(3.0f, 3.0f)), ktm::fvec2(0.707107f, 0.707107f));
