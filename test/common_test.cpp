...
int main(int argc, char* argv[])
{
    ...
    TEST_EQUAL(ktm::exp(1.0f), 2.718281828459045f);
    TEST_EQUAL(ktm::exp2(3.0f), 8.0f);
    TEST_EQUAL(ktm::expm1(1.0f), 1.718281828459045f);
    TEST_EQUAL(ktm::log(2.718281828459045f), 1.0f);
    TEST_EQUAL(ktm::log10(100.0f), 2.0f);
    TEST_EQUAL(ktm::log2(8.0f), 3.0f);
    TEST_EQUAL(ktm::log1p(1.718281828459045f), 1.0f);
    ...
    TEST_EQUAL(ktm::sin(ktm::pi<float> / 3.0f), 0.866025404f);
    TEST_EQUAL(ktm::cos(ktm::pi<float> / 3.0f), 0.5f);
    TEST_EQUAL(ktm::cos(ktm::pi<float> / 6.0f), 0.866025404f);
    TEST_EQUAL(ktm::tan(ktm::pi<float> / 6.0f), 0.577350269f);
    TEST_EQUAL(ktm::tan(ktm::pi<float> / 3.0f), 1.732050808f);
    TEST_EQUAL(ktm::asin(0.5f), ktm::pi<float> / 6.0f);
    TEST_EQUAL(ktm::asin(0.866025404f), ktm::pi<float> / 3.0f);
    TEST_EQUAL(ktm::acos(0.5f), ktm::pi<float> / 3.0f);
    TEST_EQUAL(ktm::acos(0.866025404f), ktm::pi<float> / 6.0f);
    TEST_EQUAL(ktm::atan(0.577350269f), ktm::pi<float> / 6.0f);
    TEST_EQUAL(ktm::atan(1.732050808f), ktm::pi<float> / 3.0f);
    TEST_EQUAL(ktm::atan2(0.5f, 0.866025404f), ktm::pi<float> / 6.0f);
    TEST_EQUAL(ktm::atan2(0.866025404f, 0.5f), ktm::pi<float> / 3.0f);
    TEST_EQUAL(ktm::sinc(ktm::pi<float> / 4.0f), 0.900316316f);
    TEST_EQUAL(ktm::sinh(0.5f), 0.521095305f);
    TEST_EQUAL(ktm::sinh(1.2f), 1.509461355f);
    TEST_EQUAL(ktm::cosh(0.5f), 1.127625965f);
    TEST_EQUAL(ktm::cosh(1.2f), 1.810655566f);
    TEST_EQUAL(ktm::tanh(0.5f), 0.462117157f);
    TEST_EQUAL(ktm::tanh(1.2f), 0.833654607f);
    TEST_EQUAL(ktm::asinh(1.5f), 1.194763217f);
    TEST_EQUAL(ktm::asinh(2.5f), 1.647231146f);
    TEST_EQUAL(ktm::acosh(1.5f), 0.962423650f);
    TEST_EQUAL(ktm::acosh(2.5f), 1.566799236f);
    TEST_EQUAL(ktm::atanh(0.5f), 0.549306144f);
    ...
    TEST_EQUAL(ktm::rsqrt(ktm::fvec2(4.0f, 9.0f)), ktm::fvec2(0.5f, 0.333333333f));
    TEST_EQUAL(ktm::pow(ktm::fvec2(2.0f), ktm::fvec2(3.0f)), ktm::fvec2(8.0f));
    TEST_EQUAL(ktm::exp(ktm::fvec2(0.0f, 1.0f)), ktm::fvec2(1.0f, 2.718281828459045f));
    TEST_EQUAL(ktm::log(ktm::fvec2(1.0f, 2.718281828459045f)), ktm::fvec2(0.0f, 1.0f));
    TEST_EQUAL_FAST(ktm::fast::sqrt(ktm::fvec2(4.0f, 9.0f)), ktm::fvec2(2.0f, 3.0f));
    TEST_EQUAL_FAST(ktm::fast::rsqrt(ktm::fvec2(4.0f, 9.0f)), ktm::fvec2(0.5f, 0.333333333f));
    TEST_EQUAL_FAST(ktm::fast::recip(ktm::fvec2(2.0f, 4.0f)), ktm::fvec2(0.5f, 0.25f));
    TEST_EQUAL(ktm::sin(ktm::fvec2(ktm::pi<float> / 6.0f, ktm::pi<float> / 3.0f)), ktm::fvec2(0.5f, 0.866025404f));
    TEST_EQUAL(ktm::cos(ktm::fvec2(ktm::pi<float> / 3.0f, ktm::pi<float> / 6.0f)), ktm::fvec2(0.5f, 0.866025404f));
    TEST_EQUAL(ktm::tan(ktm::fvec2(ktm::pi<float> / 6.0f, ktm::pi<float> / 3.0f)),
               ktm::fvec2(0.577350269f, 1.732050808f));
    TEST_EQUAL(ktm::sinh(ktm::fvec2(0.5f, 1.2f)), ktm::fvec2(0.521095305f, 1.509461355f));
    TEST_EQUAL(ktm::cosh(ktm::fvec2(0.5f, 1.2f)), ktm::fvec2(1.127625965f, 1.810655566f));
    TEST_EQUAL(ktm::tanh(ktm::fvec2(0.5f, 1.2f)), ktm::fvec2(0.462117157f, 0.833654607f));
