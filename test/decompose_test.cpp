...
int main(int argc, char* argv[])
{
    ...
    ktm::mat<6, 4, double> mt4 = { { 1, 4, 7, 2 },   { 4, 5, -1, 4 },      { 7.2, -1.6, -2, -5 },
    ...
    std::cout << affine1.get_translate() * affine1.get_rotate() * affine1.get_shear() * affine1.get_scale()
              << std::endl;

    std::cout << std::endl;

    ktm::mat<6, 6, double> mt8 = { { 1.f, 4.f, 7.f, 2.f, 5.f, 0.f },      { 4.f, 5.f, -1.f, 4.f, 3.f, 0.f },
                                   { 7.2f, -1.6f, -2.f, -5.f, 4.f, 0.f }, { 2.f, 4.f, 5.f, 7.5f, 0.8f, 0.f },
                                   { 3.8f, -1.f, 4.f, -5.4f, 4.6f, 0.f }, { 8.f, 9.f, -2.f, 7.6f, 9.1f, 1.f } };
    ...
    std::cout << affine2.get_translate() * affine2.get_rotate() * affine2.get_shear() * affine2.get_scale()
              << std::endl;
