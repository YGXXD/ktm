...
struct ktm::detail::vector_reduce_implement::reduce_add<4, float>
{
    ...
    static KTM_CORE_FUNC float call(const V& x) noexcept { return skv::radd_fv4(x.st); }
};
...
struct ktm::detail::vector_reduce_implement::reduce_min<4, float>
{
    ...
    static KTM_CORE_FUNC float call(const V& x) noexcept { return skv::rmin_fv4(x.st); }
};
...
struct ktm::detail::vector_reduce_implement::reduce_max<4, float>
{
    ...
    static KTM_CORE_FUNC float call(const V& x) noexcept { return skv::rmax_fv4(x.st); }
};
...
struct ktm::detail::vector_reduce_implement::reduce_add<4, int>
{
    ...
    static KTM_CORE_FUNC int call(const V& x) noexcept { return skv::radd_sv4(x.st); }
};
...
struct ktm::detail::vector_reduce_implement::reduce_min<4, int>
{
    ...
    static KTM_CORE_FUNC int call(const V& x) noexcept { return skv::rmin_sv4(x.st); }
};
...
struct ktm::detail::vector_reduce_implement::reduce_max<4, int>
{
    ...
    static KTM_CORE_FUNC int call(const V& x) noexcept { return skv::rmax_sv4(x.st); }
};
