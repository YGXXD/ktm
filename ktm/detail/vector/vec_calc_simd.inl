...
template<>
KTM_INLINE void ktm::detail::vec_calc_implement::add<float>(vec<3, float>& out, const vec<3, float>& x, const vec<3, float>& y) noexcept
{
    out.st = _add128_f32(x.st, y.st);
}

template<>
KTM_INLINE void ktm::detail::vec_calc_implement::sub<float>(vec<3, float>& out, const vec<3, float>& x, const vec<3, float>& y) noexcept
{
...
template<>
KTM_INLINE void ktm::detail::vec_calc_implement::mul<float>(vec<3, float>& out, const vec<3, float>& x, const vec<3, float>& y) noexcept
{
    out.st = _mul128_f32(x.st, y.st);
}

template<>
KTM_INLINE void ktm::detail::vec_calc_implement::div<float>(vec<3, float>& out, const vec<3, float>& x, const vec<3, float>& y) noexcept
{
...
template<>
KTM_INLINE void ktm::detail::vec_calc_implement::sub_scalar<float>(vec<3, float>& out, const vec<3, float>& x, float scalar) noexcept
{
    out.st = _sub128_f32(x.st, _dup128_f32(scalar));
}

template<>
KTM_INLINE void ktm::detail::vec_calc_implement::mul_scalar<float>(vec<3, float>& out, const vec<3, float>& x, float scalar) noexcept
{
...
template<>
KTM_INLINE void ktm::detail::vec_calc_implement::add<int>(vec<3, int>& out, const vec<3, int>& x, const vec<3, int>& y) noexcept
{
    out.st = _add128_s32(x.st, y.st);
}

template<>
KTM_INLINE void ktm::detail::vec_calc_implement::sub<int>(vec<3, int>& out, const vec<3, int>& x, const vec<3, int>& y) noexcept
{
...
template<>
KTM_INLINE void ktm::detail::vec_calc_implement::add_scalar<int>(vec<3, int>& out, const vec<3, int>& x, int scalar) noexcept
{
    out.st = _add128_s32(x.st, _dup128_s32(scalar));
}

template<>
KTM_INLINE void ktm::detail::vec_calc_implement::sub_scalar<int>(vec<3, int>& out, const vec<3, int>& x, int scalar) noexcept
{
...
template<>
KTM_INLINE void ktm::detail::vec_calc_implement::mul<int>(vec<3, int>& out, const vec<3, int>& x, const vec<3, int>& y) noexcept
{
