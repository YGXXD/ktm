...
template <>
KTM_CORE_FUNC void ktm::detail::vec_calc_implement::neg<float>(vec<3, float>& out, const vec<3, float>& x) noexcept
{
...
template <>
KTM_CORE_FUNC void ktm::detail::vec_calc_implement::neg<int>(vec<3, int>& out, const vec<3, int>& x) noexcept
{
