...
#define KTM_DETAIL_ARRAY_CALC_LAST_PARAMS_UNARY(cast_type, index, ...) KTM_DETAIL_ARRAY_CALC_LOOP_PARAMS_UNARY(cast_type, index)
...
#define KTM_DETAIL_ARRAY_CALC_LAST_PARAMS_BINARY(cast_type, index, ...) KTM_DETAIL_ARRAY_CALC_LOOP_PARAMS_BINARY(cast_type, index)
...
#define KTM_DETAIL_ARRAY_CALC_LAST_PARAMS_TERNARY(cast_type, index, ...) KTM_DETAIL_ARRAY_CALC_LOOP_PARAMS_TERNARY(cast_type, index)

#define KTM_DETAIL_ARRAY_CALC_FUNC_PARAMS_BINARY_SCALAR(type, ...) KTM_DETAIL_ARRAY_CALC_FUNC_PARAMS_UNARY(), type scalar
...
#define KTM_DETAIL_ARRAY_CALC_LOOP_PARAMS_BINARY_SCALAR(cast_type, index, ...) KTM_DETAIL_ARRAY_CALC_LOOP_PARAMS_UNARY(cast_type, index)
#define KTM_DETAIL_ARRAY_CALC_LAST_PARAMS_BINARY_SCALAR(cast_type, index, ...) KTM_DETAIL_ARRAY_CALC_LOOP_PARAMS_BINARY_SCALAR(cast_type, index), scalar

#define KTM_DETAIL_ARRAY_CALC_FUNC_PARAMS_TERNARY_SCALAR(type, ...) KTM_DETAIL_ARRAY_CALC_FUNC_PARAMS_BINARY(), type scalar
...
#define KTM_DETAIL_ARRAY_CALC_LOOP_PARAMS_TERNARY_SCALAR(cast_type, index, ...) KTM_DETAIL_ARRAY_CALC_LOOP_PARAMS_BINARY(cast_type, index)
#define KTM_DETAIL_ARRAY_CALC_LAST_PARAMS_TERNARY_SCALAR(cast_type, index, ...) KTM_DETAIL_ARRAY_CALC_LOOP_PARAMS_TERNARY_SCALAR(cast_type, index), scalar
