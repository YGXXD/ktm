                                                                            ...
                                                                            const mat<4, 4, float>& m2) noexcept
{
    ...
    skv::fv8 m2_v_0 = _shuffo256_f32(m2_01, 4, 4, 4, 4, 0, 0, 0, 0);
    skv::fv8 m2_v_1 = _shuffo256_f32(m2_01, 5, 5, 5, 5, 1, 1, 1, 1);
    skv::fv8 m2_v_2 = _shuffo256_f32(m2_01, 6, 6, 6, 6, 2, 2, 2, 2);
    skv::fv8 m2_v_3 = _shuffo256_f32(m2_01, 7, 7, 7, 7, 3, 3, 3, 3);
    ...
    m2_v_0 = _shuffo256_f32(m2_23, 4, 4, 4, 4, 0, 0, 0, 0);
    m2_v_1 = _shuffo256_f32(m2_23, 5, 5, 5, 5, 1, 1, 1, 1);
    m2_v_2 = _shuffo256_f32(m2_23, 6, 6, 6, 6, 2, 2, 2, 2);
    m2_v_3 = _shuffo256_f32(m2_23, 7, 7, 7, 7, 3, 3, 3, 3);
                                                                          ...
                                                                          const mat<4, 4, int>& m2) noexcept
{
    ...
    skv::sv8 m2_v_0 = _shuffo256_s32(m2_01, 4, 4, 4, 4, 0, 0, 0, 0);
    skv::sv8 m2_v_1 = _shuffo256_s32(m2_01, 5, 5, 5, 5, 1, 1, 1, 1);
    skv::sv8 m2_v_2 = _shuffo256_s32(m2_01, 6, 6, 6, 6, 2, 2, 2, 2);
    skv::sv8 m2_v_3 = _shuffo256_s32(m2_01, 7, 7, 7, 7, 3, 3, 3, 3);
    ...
    m2_v_0 = _shuffo256_s32(m2_23, 4, 4, 4, 4, 0, 0, 0, 0);
    m2_v_1 = _shuffo256_s32(m2_23, 5, 5, 5, 5, 1, 1, 1, 1);
    m2_v_2 = _shuffo256_s32(m2_23, 6, 6, 6, 6, 2, 2, 2, 2);
    m2_v_3 = _shuffo256_s32(m2_23, 7, 7, 7, 7, 3, 3, 3, 3);
