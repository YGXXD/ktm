...
template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> sqrt(const V& x) noexcept
{
    return detail::vector_exponential_implement::sqrt<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> rsqrt(const V& x) noexcept
{
    return detail::vector_exponential_implement::rsqrt<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> recip(const V& x) noexcept
{
    return detail::vector_exponential_implement::recip<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> cbrt(const V& x) noexcept
{
    return detail::vector_exponential_implement::cbrt<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> pow(const V& x, const V& y) noexcept
{
    return detail::vector_exponential_implement::pow<vec_traits_len<V>, vec_traits_base_t<V>>::call(x, y);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> exp(const V& x) noexcept
{
    return detail::vector_exponential_implement::exp<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> exp2(const V& x) noexcept
{
    return detail::vector_exponential_implement::exp2<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> expm1(const V& x) noexcept
{
    return detail::vector_exponential_implement::expm1<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> log(const V& x) noexcept
{
    return detail::vector_exponential_implement::log<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> log10(const V& x) noexcept
{
    return detail::vector_exponential_implement::log10<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> log2(const V& x) noexcept
{
    return detail::vector_exponential_implement::log2<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> log1p(const V& x) noexcept
{
    return detail::vector_exponential_implement::log1p<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> logb(const V& x) noexcept
{
...
template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_listing_type_base_v<type_list<float, double>, V>, V>
