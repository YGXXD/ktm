...
template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && !is_unsigned_base_v<V>, V> abs(const V& x) noexcept
{
    return detail::vector_arithmetic_implement::abs<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V>, V> min(const V& x, const V& y) noexcept
{
    return detail::vector_arithmetic_implement::min<vec_traits_len<V>, vec_traits_base_t<V>>::call(x, y);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V>, V> max(const V& x, const V& y) noexcept
{
    return detail::vector_arithmetic_implement::max<vec_traits_len<V>, vec_traits_base_t<V>>::call(x, y);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V>, V> clamp(const V& v, const V& min, const V& max) noexcept
{
    return detail::vector_arithmetic_implement::clamp<vec_traits_len<V>, vec_traits_base_t<V>>::call(v, min, max);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> floor(const V& x) noexcept
{
    return detail::vector_arithmetic_implement::floor<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> ceil(const V& x) noexcept
{
    return detail::vector_arithmetic_implement::ceil<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> round(const V& x) noexcept
{
    return detail::vector_arithmetic_implement::round<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> fract(const V& x) noexcept
{
    return detail::vector_arithmetic_implement::fract<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> mod(const V& x, const V& y) noexcept
{
