...
template <typename T>
KTM_CORE_FUNC std::enable_if_t<std::is_floating_point_v<T>, T> lerp_rand(T min, T max) noexcept
{
...
template <typename T>
KTM_CORE_FUNC std::enable_if_t<std::is_floating_point_v<T>, T> exp_rand(T lambda) noexcept
{
...
template <typename T>
KTM_CORE_FUNC std::enable_if_t<std::is_floating_point_v<T>, vec<2, T>> disk_rand(T radius) noexcept
{
...
template <typename T>
KTM_CORE_FUNC std::enable_if_t<std::is_floating_point_v<T>, vec<3, T>> ball_rand(T radius) noexcept
{
