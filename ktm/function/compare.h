...
template<class V>
KTM_INLINE std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, bool> equal(const V& x, const V& y, vec_traits_base_t<V> e = epsilon<vec_traits_base_t<V>>) noexcept
{
    return equal_zero(x - y, e);
}

template<class V>
KTM_INLINE std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, bool> less_zero(const V& x, vec_traits_base_t<V> e = epsilon<vec_traits_base_t<V>>) noexcept
{
    return less_zero(reduce_max(x), e);
}

template<class V>
KTM_INLINE std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, bool> less(const V& x, const V& y, vec_traits_base_t<V> e = epsilon<vec_traits_base_t<V>>) noexcept
{
    return less_zero(x - y, e);
}

template<class V>
KTM_INLINE std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, bool> greater_zero(const V& x, vec_traits_base_t<V> e = epsilon<vec_traits_base_t<V>>) noexcept
{
    return greater_zero(reduce_min(x), e);
}

template<class V>
KTM_INLINE std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, bool> greater(const V& x, const V& y, vec_traits_base_t<V> e = epsilon<vec_traits_base_t<V>>) noexcept
{
    return greater_zero(x - y, e);
}
