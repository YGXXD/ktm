...
template <typename T>
KTM_CORE_FUNC std::enable_if_t<std::is_floating_point_v<T>, bool> equal_zero(T x, T e = epsilon<T>) noexcept
{
    return abs(x) <= e;
}

template <typename T>
KTM_CORE_FUNC std::enable_if_t<std::is_floating_point_v<T>, bool> equal(T x, T y, T e = epsilon<T>) noexcept
{
    return equal_zero(x - y, e);
}

template <typename T>
KTM_CORE_FUNC std::enable_if_t<std::is_floating_point_v<T>, bool> less_zero(T x, T e = epsilon<T>) noexcept
{
    return x < -e;
}

template <typename T>
KTM_CORE_FUNC std::enable_if_t<std::is_floating_point_v<T>, bool> less(T x, T y, T e = epsilon<T>) noexcept
{
    return less_zero(x - y, e);
}

template <typename T>
KTM_CORE_FUNC std::enable_if_t<std::is_floating_point_v<T>, bool> greater_zero(T x, T e = epsilon<T>) noexcept
{
    return x > e;
}

template <typename T>
KTM_CORE_FUNC std::enable_if_t<std::is_floating_point_v<T>, bool> greater(T x, T y, T e = epsilon<T>) noexcept
{
    return greater_zero(x - y, e);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, bool>
