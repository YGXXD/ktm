...
template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, vec_traits_base_t<V>>
...
template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> project(const V& x, const V& y) noexcept
{
    return detail::geometric_implement::project<vec_traits_len<V>, vec_traits_base_t<V>>::call(x, y);
}

template <typename T>
KTM_CORE_FUNC std::enable_if_t<std::is_floating_point_v<T>, vec<3, T>> cross(const vec<3, T>& x,
...
template <typename T>
KTM_CORE_FUNC std::enable_if_t<std::is_floating_point_v<T>, vec<3, T>> cross(const vec<2, T>& x,
...
template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> normalize(const V& x) noexcept
{
    return detail::geometric_implement::normalize<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> reflect(const V& x, const V& n) noexcept
{
    return detail::geometric_implement::reflect<vec_traits_len<V>, vec_traits_base_t<V>>::call(x, n);
}

template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> refract(const V& x, const V& n,
...
template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_listing_type_base_v<type_list<float, double>, V>, vec_traits_base_t<V>>
length(const V& x) noexcept
{
