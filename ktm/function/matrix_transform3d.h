...
template<typename T>
KTM_INLINE std::enable_if_t<std::is_floating_point_v<T>, mat<4, 4, T>> look_to_lh(const vec<3, T>& eye_pos, const vec<3, T>& direction, const vec<3, T>& up) noexcept
{
...
template<typename T>
KTM_INLINE std::enable_if_t<std::is_floating_point_v<T>, mat<4, 4, T>> look_to_rh(const vec<3, T>& eye_pos, const vec<3, T>& direction, const vec<3, T>& up) noexcept
{
...
template<typename T>
KTM_INLINE std::enable_if_t<std::is_floating_point_v<T>, mat<4, 4, T>> rotate3d_axis_x(T angle) noexcept
{
...
template<typename T>
KTM_INLINE std::enable_if_t<std::is_floating_point_v<T>, mat<4, 4, T>> rotate3d_axis_y(T angle) noexcept
{
    T cos_theta = cos(angle);
    T sin_theta = sin(angle);
...
template<typename T>
KTM_INLINE std::enable_if_t<std::is_floating_point_v<T>, mat<4, 4, T>> rotate3d_axis_z(T angle) noexcept
{
    T cos_theta = cos(angle);
    T sin_theta = sin(angle);
