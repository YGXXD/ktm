...
private:
    ...
    KTM_CORE_FUNC vec<3, T> add_impl(const vec<3, T>& y) const noexcept
    {
        vec<3, T> ret;
    ...
    KTM_CORE_FUNC vec<3, T>& add_to_self_impl(const vec<3, T>& y) noexcept
    {
        detail::vec_calc_implement::add<T>(*child_ptr(), *child_ptr(), y);
        return *child_ptr();
    }

    KTM_CORE_FUNC vec<3, T> sub_impl(const vec<3, T>& y) const noexcept
    {
        vec<3, T> ret;
    ...
    KTM_CORE_FUNC vec<3, T>& sub_to_self_impl(const vec<3, T>& y) noexcept
    {
        detail::vec_calc_implement::sub<T>(*child_ptr(), *child_ptr(), y);
        return *child_ptr();
    }

    KTM_CORE_FUNC vec<3, T> neg_impl() const noexcept
    {
        vec<3, T> ret;
    ...
    KTM_CORE_FUNC vec<3, T> mul_impl(const vec<3, T>& y) const noexcept
    {
        vec<3, T> ret;
    ...
    KTM_CORE_FUNC vec<3, T>& mul_to_self_impl(const vec<3, T>& y) noexcept
    {
        detail::vec_calc_implement::mul<T>(*child_ptr(), *child_ptr(), y);
        return *child_ptr();
    }

    KTM_CORE_FUNC vec<3, T> div_impl(const vec<3, T>& y) const noexcept
    {
        vec<3, T> ret;
    ...
    KTM_CORE_FUNC vec<3, T>& div_to_self_impl(const vec<3, T>& y) noexcept
    {
    ...
    KTM_CORE_FUNC vec<3, T> madd_impl(const vec<3, T>& y, const vec<3, T>& z) const noexcept
    {
        vec<3, T> ret;
    ...
    KTM_CORE_FUNC vec<3, T>& madd_to_self_impl(const vec<3, T>& y, const vec<3, T>& z) noexcept
    {
    ...
    KTM_CORE_FUNC vec<3, T> add_scalar_impl(T scalar) const noexcept
    {
        vec<3, T> ret;
    ...
    KTM_CORE_FUNC vec<3, T>& add_scalar_to_self_impl(T scalar) noexcept
    {
        detail::vec_calc_implement::add_scalar<T>(*child_ptr(), *child_ptr(), scalar);
        return *child_ptr();
    }

    KTM_CORE_FUNC vec<3, T> sub_scalar_impl(T scalar) const noexcept
    {
        vec<3, T> ret;
    ...
    KTM_CORE_FUNC vec<3, T>& sub_scalar_to_self_impl(T scalar) noexcept
    {
    ...
    KTM_CORE_FUNC vec<3, T> mul_scalar_impl(T scalar) const noexcept
    {
        vec<3, T> ret;
    ...
    KTM_CORE_FUNC vec<3, T>& mul_scalar_to_self_impl(T scalar) noexcept
    {
        detail::vec_calc_implement::mul_scalar<T>(*child_ptr(), *child_ptr(), scalar);
        return *child_ptr();
    }

    KTM_CORE_FUNC vec<3, T> div_scalar_impl(T scalar) const noexcept
    {
        vec<3, T> ret;
    ...
    KTM_CORE_FUNC vec<3, T>& div_scalar_to_self_impl(T scalar) noexcept
    {
    ...
    KTM_CORE_FUNC vec<3, T> madd_scalar_impl(const vec<3, T>& y, T scalar) const noexcept
    {
        vec<3, T> ret;
    ...
    KTM_CORE_FUNC vec<3, T>& madd_scalar_to_self_impl(const vec<3, T>& y, T scalar) noexcept
    {
