...
struct iarray_add : Father
{
    ...
    friend KTM_INLINE Child operator+(const Child& x, const Child& y) noexcept { return x.add(y); }

    friend KTM_INLINE Child& operator+=(Child& x, const Child& y) noexcept { return x.add_to_self(y); }

    friend KTM_INLINE Child operator-(const Child& x, const Child& y) noexcept { return x.sub(y); }

    friend KTM_INLINE Child& operator-=(Child& x, const Child& y) noexcept { return x.sub_to_self(y); }

    friend KTM_INLINE Child operator-(const Child& x) noexcept { return x.neg(); }

private:
    KTM_CRTP_INTERFACE_REGISTER(add, add_impl)

    KTM_INLINE Child add(const Child& y) const noexcept
    {
    ...
    KTM_INLINE Child& add_to_self(const Child& y) noexcept
    {
    ...
    KTM_INLINE Child sub(const Child& y) const noexcept
    {
    ...
    KTM_INLINE Child& sub_to_self(const Child& y) noexcept
    {
    ...
    KTM_INLINE Child neg() const noexcept
    {
...
struct iarray_mul : Father
{
    ...
    friend KTM_INLINE Child operator*(const Child& x, const Child& y) noexcept { return x.mul(y); }

    friend KTM_INLINE Child& operator*=(Child& x, const Child& y) noexcept { return x.mul_to_self(y); }

    friend KTM_INLINE Child operator/(const Child& x, const Child& y) noexcept { return x.div(y); }

    friend KTM_INLINE Child& operator/=(Child& x, const Child& y) noexcept { return x.div_to_self(y); }

private:
    KTM_CRTP_INTERFACE_REGISTER(mul, mul_impl)

    KTM_INLINE Child mul(const Child& y) const noexcept
    {
    ...
    KTM_INLINE Child& mul_to_self(const Child& y) noexcept
    {
    ...
    KTM_INLINE Child div(const Child& y) const noexcept
    {
    ...
    KTM_INLINE Child& div_to_self(const Child& y) noexcept
    {
...
struct iarray_add_scalar : Father
{
    ...
    friend KTM_INLINE Child operator+(const Child& x, ScalarT scalar) noexcept { return x.add_scalar(scalar); }

    friend KTM_INLINE Child& operator+=(Child& x, ScalarT scalar) noexcept { return x.add_scalar_to_self(scalar); }

    friend KTM_INLINE Child operator-(const Child& x, ScalarT scalar) noexcept { return x.sub_scalar(scalar); }

    friend KTM_INLINE Child& operator-=(Child& x, ScalarT scalar) noexcept { return x.sub_scalar_to_self(scalar); }

    friend KTM_INLINE Child operator+(ScalarT scalar, const Child& x) noexcept { return x + scalar; }

private:
    KTM_CRTP_INTERFACE_REGISTER(add_scalar, add_scalar_impl)

    KTM_INLINE Child add_scalar(ScalarT scalar) const noexcept
    {
    ...
    KTM_INLINE Child& add_scalar_to_self(ScalarT scalar) noexcept
    {
    ...
    KTM_INLINE Child sub_scalar(ScalarT scalar) const noexcept
    {
    ...
    KTM_INLINE Child& sub_scalar_to_self(ScalarT scalar) noexcept
    {
...
struct iarray_mul_scalar : Father
{
    ...
    friend KTM_INLINE Child operator*(const Child& x, ScalarT scalar) noexcept { return x.mul_scalar(scalar); }

    friend KTM_INLINE Child& operator*=(Child& x, ScalarT scalar) noexcept { return x.mul_scalar_to_self(scalar); }

    friend KTM_INLINE Child operator/(const Child& x, ScalarT scalar) noexcept { return x.div_scalar(scalar); }

    friend KTM_INLINE Child& operator/=(Child& x, ScalarT scalar) noexcept { return x.div_scalar_to_self(scalar); }
...
private:
    ...
    KTM_INLINE Child mul_scalar(ScalarT scalar) const noexcept
    {
    ...
    KTM_INLINE Child& mul_scalar_to_self(ScalarT scalar) noexcept
    {
    ...
    KTM_INLINE Child div_scalar(ScalarT scalar) const noexcept
    {
    ...
    KTM_INLINE Child& div_scalar_to_self(ScalarT scalar) noexcept
    {
...
struct iarray_madd : Father
{
    ...
    friend KTM_INLINE Child ktm_op_madd(const Child& x, const Child& y, const Child& z) noexcept
    {
        return x.madd(y, z);
    }

    friend KTM_INLINE Child ktm_op_smadd(Child& x, const Child& y, const Child& z) noexcept
    {
...
private:
    ...
    KTM_INLINE Child madd(const Child& y, const Child& z) const noexcept
    {
    ...
    KTM_INLINE Child& madd_to_self(const Child& y, const Child& z) noexcept
    {
...
struct iarray_madd_scalar : Father
{
    ...
    friend KTM_INLINE Child ktm_op_madd(const Child& x, const Child& y, ScalarT scalar) noexcept
    {
        return x.madd_scalar(y, scalar);
    }

    friend KTM_INLINE Child ktm_op_madd(const Child& x, ScalarT scalar, const Child& z) noexcept
    {
        return x.madd_scalar(z, scalar);
    }

    friend KTM_INLINE Child ktm_op_smadd(Child& x, const Child& y, ScalarT scalar) noexcept
    {
        return x.madd_scalar_to_self(y, scalar);
    }

    friend KTM_INLINE Child ktm_op_smadd(Child& x, ScalarT scalar, const Child& z) noexcept
    {
...
private:
    ...
    KTM_INLINE Child madd_scalar(const Child& y, ScalarT scalar) const noexcept
    {
    ...
    KTM_INLINE Child& madd_scalar_to_self(const Child& y, ScalarT scalar) noexcept
    {
