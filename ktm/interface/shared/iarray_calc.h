...
struct iarray_add : Father
{
    ...
    friend KTM_FUNC Child operator+(const Child& x, const Child& y) noexcept
    {
        return x.add(y);
    }

    friend KTM_FUNC Child& operator+=(Child& x, const Child& y) noexcept
    {
        return x.add_to_self(y);
    }
    ...
    friend KTM_FUNC Child& operator-=(Child& x, const Child& y) noexcept
    {
        return x.sub_to_self(y);
    }

    friend KTM_FUNC Child operator-(const Child& x) noexcept
    {
        return x.neg();
    }
...
struct iarray_add_scalar : Father
{
    ...
    friend KTM_FUNC Child operator+(const Child& x, ScalarT scalar) noexcept
    {
        return x.add_scalar(scalar);
    }

    friend KTM_FUNC Child& operator+=(Child& x, ScalarT scalar) noexcept
    {
        return x.add_scalar_to_self(scalar);
    }

    friend KTM_FUNC Child operator-(const Child& x, ScalarT scalar) noexcept
    {
        return x.sub_scalar(scalar);
    }

    friend KTM_FUNC Child& operator-=(Child& x, ScalarT scalar) noexcept
    {
        return x.sub_scalar_to_self(scalar);
    }

    friend KTM_FUNC Child operator+(ScalarT scalar, const Child& x) noexcept
    {
        return x + scalar;
    }
...
struct iarray_mul_scalar : Father
{
    ...
    friend KTM_FUNC Child operator*(const Child& x, ScalarT scalar) noexcept
    {
        return x.mul_scalar(scalar);
    }

    friend KTM_FUNC Child& operator*=(Child& x, ScalarT scalar) noexcept
    {
        return x.mul_scalar_to_self(scalar);
    }

    friend KTM_FUNC Child operator/(const Child& x, ScalarT scalar) noexcept
    {
        return x.div_scalar(scalar);
    }

    friend KTM_FUNC Child& operator/=(Child& x, ScalarT scalar) noexcept
    {
        return x.div_scalar_to_self(scalar);
    }
