...
struct iarray_io : Father
{
    ...
    friend KTM_CORE_FUNC std::basic_ostream<char>& operator<<(std::basic_ostream<char>& out, const Child& x) noexcept
    {
        return x.stream_out(out);
    }

    friend KTM_CORE_FUNC std::basic_istream<char>& operator>>(std::basic_istream<char>& in, Child& x) noexcept
    {
    ...
    friend KTM_CORE_FUNC std::basic_istream<wchar_t>& operator>>(std::basic_istream<wchar_t>& in, Child& x) noexcept
    {
...
private:
    ...
    KTM_CORE_FUNC std::basic_ostream<char>& stream_out(std::basic_ostream<char>& o) const noexcept
    {
    ...
    KTM_CORE_FUNC std::basic_istream<char>& stream_in(std::basic_istream<char>& i) noexcept
    {
    ...
    KTM_CORE_FUNC std::basic_ostream<wchar_t>& wstream_out(std::basic_ostream<wchar_t>& o) const noexcept
    {
    ...
    KTM_CORE_FUNC std::basic_istream<wchar_t>& wstream_in(std::basic_istream<wchar_t>& i) noexcept
    {
    ...
    template <typename T>
    KTM_CORE_FUNC std::basic_ostream<T>& stream_out_default(std::basic_ostream<T>& o) const noexcept
    {
    ...
    template <typename T>
    KTM_CORE_FUNC std::basic_istream<T>& stream_in_default(std::basic_istream<T>& i) noexcept
    {
        using VT = typename std::decay_t<decltype(child_ptr()->to_array())>::value_type;
