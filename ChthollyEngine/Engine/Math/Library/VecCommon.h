...
template<class V>
CHTHOLLY_INLINE vec_traits_base_t<V> reduce_add(const V& x) noexcept
{
    return detail::vec_common_implement::reduce_add<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template<class V>
CHTHOLLY_INLINE vec_traits_base_t<V> reduce_min(const V& x) noexcept
{
    return detail::vec_common_implement::reduce_min<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
}

template<class V>
CHTHOLLY_INLINE vec_traits_base_t<V> reduce_max(const V& x) noexcept
{
...
template<class V>
CHTHOLLY_INLINE std::enable_if_t<std::is_floating_point_v<vec_traits_base_t<V>>, V> lerp(const V& x, const V& y, vec_traits_base_t<V> t) noexcept
{
    return detail::vec_common_implement::lerp<vec_traits_len<V>, vec_traits_base_t<V>>::call(x, y, t);
}

template<class V>
CHTHOLLY_INLINE std::enable_if_t<std::is_floating_point_v<vec_traits_base_t<V>>, V> mix(const V& x, const V& y, const V& t) noexcept
{
    return detail::vec_common_implement::mix<vec_traits_len<V>, vec_traits_base_t<V>>::call(x, y, t);
}

template<class V>
CHTHOLLY_INLINE std::enable_if_t<std::is_floating_point_v<vec_traits_base_t<V>>, V> recip(const V& x) noexcept
{
    return detail::vec_common_implement::recip<vec_traits_len<V>, vec_traits_base_t<V>>::call(x);
} 

template<class V>
CHTHOLLY_INLINE std::enable_if_t<std::is_floating_point_v<vec_traits_base_t<V>>, V> step(const V& edge, const V& x) noexcept
{
    return detail::vec_common_implement::step<vec_traits_len<V>, vec_traits_base_t<V>>::call(edge, x);
} 

template<class V>
CHTHOLLY_INLINE std::enable_if_t<std::is_floating_point_v<vec_traits_base_t<V>>, V> smoothstep(const V& edge0, const V& edge1, const V& x) noexcept
{
    return detail::vec_common_implement::smoothstep<vec_traits_len<V>, vec_traits_base_t<V>>::call(edge0, edge1, x);
}

template<class V>
CHTHOLLY_INLINE std::enable_if_t<std::is_floating_point_v<vec_traits_base_t<V>>, V> fract(const V& x) noexcept
{
