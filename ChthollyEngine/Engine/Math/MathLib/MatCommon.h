...
namespace ktm
{
    ...
    {
        return detail::mat_common_implement::transpose<mat_traits_col_n<M>, mat_traits_row_n<M>, mat_traits_t<M>>::call(m);
    } 
    ...
    template<class M>
    CHTHOLLY_INLINE std::enable_if_t<mat_traits_col_n<M> == mat_traits_row_n<M> && std::is_floating_point_v<mat_traits_t<M>>, M> inverse(const M& m)
    {
