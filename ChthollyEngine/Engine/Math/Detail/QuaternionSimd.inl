...
struct ktm::detail::quat_opt_implement::mul<float>
{
    ...
    static CHTHOLLY_INLINE Q call(const Q& x, const Q& y) noexcept
    {
        ...
        float32x4_t tmp_0 = acsi_vshuffleq_f32(t_y, t_y_opp, 3, 2, 3, 2);
        float32x4_t tmp_1 = acsi_vshuffleq_f32(t_y, t_y_opp, 1, 1, 0, 0); 

        float32x4_t mul_x = acsi_vshuffleq_f32(tmp_1, tmp_0, 0, 3, 0, 2); 
        float32x4_t mul_y = acsi_vshuffleq_f32(tmp_0, tmp_1, 2, 0, 1, 2); 
        float32x4_t mul_z = acsi_vshuffleq_f32(t_y_opp, t_y, 0, 1, 2, 3);
