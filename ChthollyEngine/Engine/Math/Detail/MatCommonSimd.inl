...
struct ktm::detail::mat_common_implement::transpose<3, 3, float>
{
    ...
    static CHTHOLLY_INLINE RetM call(const M& m) noexcept
    {
        ...
        float32x4_t tmp_0 = neon_shuffleq_f32(c_0, c_1, 1, 0, 1, 0);
        float32x4_t tmp_1 = neon_shuffleq_f32(c_0, c_1, 3, 2, 3, 2);

        float32x4_t ret_0 = neon_shuffleq_f32(tmp_0, c_2, 3, 0, 2, 0);
        float32x4_t ret_1 = neon_shuffleq_f32(tmp_0, c_2, 3, 1, 3, 1);
        float32x4_t ret_2 = neon_shuffleq_f32(tmp_1, c_2, 3, 2, 2, 0);
...
struct ktm::detail::mat_common_implement::transpose<4, 4, float>
{
    ...
    static CHTHOLLY_INLINE RetM call(const M& m) noexcept
    {
        ...
        float32x4_t tmp_0 = neon_shuffleq_f32(c_0, c_1, 1, 0, 1, 0);
        float32x4_t tmp_2 = neon_shuffleq_f32(c_0, c_1, 3, 2, 3, 2);
        float32x4_t tmp_1 = neon_shuffleq_f32(c_2, c_3, 1, 0, 1, 0);
        float32x4_t tmp_3 = neon_shuffleq_f32(c_2, c_3, 3, 2, 3, 2);

        float32x4_t ret_0 = neon_shuffleq_f32(tmp_0, tmp_1, 2, 0, 2, 0);
        float32x4_t ret_1 = neon_shuffleq_f32(tmp_0, tmp_1, 3, 1, 3, 1);
        float32x4_t ret_2 = neon_shuffleq_f32(tmp_2, tmp_3, 2, 0, 2, 0);
        float32x4_t ret_3 = neon_shuffleq_f32(tmp_2, tmp_3, 3, 1, 3, 1);
...
struct ktm::detail::mat_common_implement::transpose<3, 3, int>
{
    ...
    static CHTHOLLY_INLINE RetM call(const M& m) noexcept
    {
        ...
        int32x4_t tmp_0 = neon_shuffleq_s32(c_0, c_1, 1, 0, 1, 0);
        int32x4_t tmp_1 = neon_shuffleq_s32(c_0, c_1, 3, 2, 3, 2);

        int32x4_t ret_0 = neon_shuffleq_s32(tmp_0, c_2, 3, 0, 2, 0);
        int32x4_t ret_1 = neon_shuffleq_s32(tmp_0, c_2, 3, 1, 3, 1);
        int32x4_t ret_2 = neon_shuffleq_s32(tmp_1, c_2, 3, 2, 2, 0);
...
struct ktm::detail::mat_common_implement::transpose<4, 4, int>
{
    ...
    static CHTHOLLY_INLINE RetM call(const M& m) noexcept
    {
        ...
        int32x4_t tmp_0 = neon_shuffleq_s32(c_0, c_1, 1, 0, 1, 0);
        int32x4_t tmp_2 = neon_shuffleq_s32(c_0, c_1, 3, 2, 3, 2);
        int32x4_t tmp_1 = neon_shuffleq_s32(c_2, c_3, 1, 0, 1, 0);
        int32x4_t tmp_3 = neon_shuffleq_s32(c_2, c_3, 3, 2, 3, 2);

        int32x4_t ret_0 = neon_shuffleq_s32(tmp_0, tmp_1, 2, 0, 2, 0);
        int32x4_t ret_1 = neon_shuffleq_s32(tmp_0, tmp_1, 3, 1, 3, 1);
        int32x4_t ret_2 = neon_shuffleq_s32(tmp_2, tmp_3, 2, 0, 2, 0);
        int32x4_t ret_3 = neon_shuffleq_s32(tmp_2, tmp_3, 3, 1, 3, 1);
...
struct ktm::detail::mat_common_implement::determinant<3, float>
{
    ...
    static CHTHOLLY_INLINE float call(const M& m) noexcept
    {
        ...
        return neon::dotvq_f32<3>(c_0, sub_0);
    }
};
...
struct ktm::detail::mat_common_implement::determinant<3, int>
{
    ...
    static CHTHOLLY_INLINE float call(const M& m) noexcept
    {
        ...
        return neon::dotvq_s32<3>(c_0, sub_0);
    }
};
...
struct ktm::detail::mat_common_implement::inverse<4, float>
{
    ...
    static CHTHOLLY_INLINE M call(const M& m) noexcept
    {
        ...
        float32x4_t i_dot_0 = neon::dotq_f32(c_0, i_row_0);
