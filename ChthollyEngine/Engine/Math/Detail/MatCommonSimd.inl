...
struct ktm::detail::mat_common_implement::transpose<3, 3, float>
{
    ...
    static CHTHOLLY_INLINE RetM call(const M& m) noexcept
    {
        ...
        float32x4_t tmp_0 = neon_vshuffleq_f32(c_0, c_1, 1, 0, 1, 0);
        float32x4_t tmp_1 = neon_vshuffleq_f32(c_0, c_1, 3, 2, 3, 2);

        float32x4_t ret_0 = neon_vshuffleq_f32(tmp_0, c_2, 3, 0, 2, 0);
        float32x4_t ret_1 = neon_vshuffleq_f32(tmp_0, c_2, 3, 1, 3, 1);
        float32x4_t ret_2 = neon_vshuffleq_f32(tmp_1, c_2, 3, 2, 2, 0);
...
struct ktm::detail::mat_common_implement::transpose<4, 4, float>
{
    ...
    static CHTHOLLY_INLINE RetM call(const M& m) noexcept
    {
        ...
        float32x4_t tmp_0 = neon_vshuffleq_f32(c_0, c_1, 1, 0, 1, 0);
        float32x4_t tmp_2 = neon_vshuffleq_f32(c_0, c_1, 3, 2, 3, 2);
        float32x4_t tmp_1 = neon_vshuffleq_f32(c_2, c_3, 1, 0, 1, 0);
        float32x4_t tmp_3 = neon_vshuffleq_f32(c_2, c_3, 3, 2, 3, 2);

        float32x4_t ret_0 = neon_vshuffleq_f32(tmp_0, tmp_1, 2, 0, 2, 0);
        float32x4_t ret_1 = neon_vshuffleq_f32(tmp_0, tmp_1, 3, 1, 3, 1);
        float32x4_t ret_2 = neon_vshuffleq_f32(tmp_2, tmp_3, 2, 0, 2, 0);
        float32x4_t ret_3 = neon_vshuffleq_f32(tmp_2, tmp_3, 3, 1, 3, 1);
...
struct ktm::detail::mat_common_implement::transpose<3, 3, int>
{
    ...
    static CHTHOLLY_INLINE RetM call(const M& m) noexcept
    {
        ...
        int32x4_t tmp_0 = neon_vshuffleq_s32(c_0, c_1, 1, 0, 1, 0);
        int32x4_t tmp_1 = neon_vshuffleq_s32(c_0, c_1, 3, 2, 3, 2);

        int32x4_t ret_0 = neon_vshuffleq_s32(tmp_0, c_2, 3, 0, 2, 0);
        int32x4_t ret_1 = neon_vshuffleq_s32(tmp_0, c_2, 3, 1, 3, 1);
        int32x4_t ret_2 = neon_vshuffleq_s32(tmp_1, c_2, 3, 2, 2, 0);
...
struct ktm::detail::mat_common_implement::transpose<4, 4, int>
{
    ...
    static CHTHOLLY_INLINE RetM call(const M& m) noexcept
    {
        ...
        int32x4_t tmp_0 = neon_vshuffleq_s32(c_0, c_1, 1, 0, 1, 0);
        int32x4_t tmp_2 = neon_vshuffleq_s32(c_0, c_1, 3, 2, 3, 2);
        int32x4_t tmp_1 = neon_vshuffleq_s32(c_2, c_3, 1, 0, 1, 0);
        int32x4_t tmp_3 = neon_vshuffleq_s32(c_2, c_3, 3, 2, 3, 2);

        int32x4_t ret_0 = neon_vshuffleq_s32(tmp_0, tmp_1, 2, 0, 2, 0);
        int32x4_t ret_1 = neon_vshuffleq_s32(tmp_0, tmp_1, 3, 1, 3, 1);
        int32x4_t ret_2 = neon_vshuffleq_s32(tmp_2, tmp_3, 2, 0, 2, 0);
        int32x4_t ret_3 = neon_vshuffleq_s32(tmp_2, tmp_3, 3, 1, 3, 1);
...
struct ktm::detail::mat_common_implement::determinant<3, float>
{
    ...
    static CHTHOLLY_INLINE float call(const M& m) noexcept
    {
        ...
        float32x4_t c_1 = vld1q_f32(&m[1][0]);
        float32x4_t c_2 = vld1q_f32(&m[2][0]);
        float32x4_t mul_00 = vmulq_f32(neon_vshuffleq_f32(c_1, c_1, 3, 0, 2, 1), neon_vshuffleq_f32(c_2, c_2, 3, 1, 0, 2));
        float32x4_t mul_01 = vmulq_f32(neon_vshuffleq_f32(c_1, c_1, 3, 1, 0, 2), neon_vshuffleq_f32(c_2, c_2, 3, 0, 2, 1));
        float32x4_t sub_0 = vsubq_f32(mul_00, mul_01);  
        return neon::vdotvq_f32<3>(c_0, sub_0);
    }
};
...
struct ktm::detail::mat_common_implement::determinant<4, float>
{
    ...
    static CHTHOLLY_INLINE float call(const M& m) noexcept
    {
        ...
        float32x4_t mul_0;
        {
            float32x4_t mul_00 = vmulq_f32(neon_vshuffleq_f32(c_2, c_2, 1, 0, 3, 2), neon_vshuffleq_f32(c_3, c_3, 2, 1, 0, 3));
            float32x4_t mul_01 = vmulq_f32(neon_vshuffleq_f32(c_2, c_2, 2, 1, 0, 3), neon_vshuffleq_f32(c_3, c_3, 1, 0, 3, 2));
            float32x4_t sub_0 = vsubq_f32(mul_00, mul_01);
            mul_0 = vmulq_f32(neon_vshuffleq_f32(c_1, c_1, 0, 3, 2, 1), sub_0);
        }

        float32x4_t mul_1;
        {
            float32x4_t mul_00 = vmulq_f32(neon_vshuffleq_f32(c_2, c_2, 2, 1, 0, 3), neon_vshuffleq_f32(c_3, c_3, 0, 3, 2, 1));
            float32x4_t mul_01 = vmulq_f32(neon_vshuffleq_f32(c_2, c_2, 0, 3, 2, 1), neon_vshuffleq_f32(c_3, c_3, 2, 1, 0, 3));
            float32x4_t sub_0 = vsubq_f32(mul_00, mul_01);
            mul_1 = vmulq_f32(neon_vshuffleq_f32(c_1, c_1, 1, 0, 3, 2), sub_0);
        }

        float32x4_t mul_2;
        {
            float32x4_t mul_00 = vmulq_f32(neon_vshuffleq_f32(c_2, c_2, 0, 3, 2, 1), neon_vshuffleq_f32(c_3, c_3, 1, 0, 3, 2));
            float32x4_t mul_01 = vmulq_f32(neon_vshuffleq_f32(c_2, c_2, 1, 0, 3, 2), neon_vshuffleq_f32(c_3, c_3, 0, 3, 2, 1));
            float32x4_t sub_0 = vsubq_f32(mul_00, mul_01);
            mul_2 = vmulq_f32(neon_vshuffleq_f32(c_1, c_1, 2, 1, 0, 3), sub_0);
        }

        float32x4_t mul_3 = vmulq_f32(c_0, vaddq_f32(vaddq_f32(mul_0, mul_1), mul_2)); 
        mul_3 = neon_vshuffleq_f32(mul_3, mul_3, 3, 1, 2, 0);
...
struct ktm::detail::mat_common_implement::determinant<3, int>
{
    ...
    static CHTHOLLY_INLINE float call(const M& m) noexcept
    {
        ...
        int32x4_t c_1 = vld1q_s32(&m[1][0]);
        int32x4_t c_2 = vld1q_s32(&m[2][0]);
        int32x4_t mul_00 = vmulq_s32(neon_vshuffleq_s32(c_1, c_1, 3, 0, 2, 1), neon_vshuffleq_s32(c_2, c_2, 3, 1, 0, 2));
        int32x4_t mul_01 = vmulq_s32(neon_vshuffleq_s32(c_1, c_1, 3, 1, 0, 2), neon_vshuffleq_s32(c_2, c_2, 3, 0, 2, 1));
        int32x4_t sub_0 = vsubq_s32(mul_00, mul_01);  
        return neon::vdotvq_s32<3>(c_0, sub_0);
    }
};
...
struct ktm::detail::mat_common_implement::determinant<4, int>
{
    ...
    static CHTHOLLY_INLINE float call(const M& m) noexcept
    {
        ...
        int32x4_t mul_0;
        {
            int32x4_t mul_00 = vmulq_s32(neon_vshuffleq_s32(c_2, c_2, 1, 0, 3, 2), neon_vshuffleq_s32(c_3, c_3, 2, 1, 0, 3));
            int32x4_t mul_01 = vmulq_s32(neon_vshuffleq_s32(c_2, c_2, 2, 1, 0, 3), neon_vshuffleq_s32(c_3, c_3, 1, 0, 3, 2));
            int32x4_t sub_0 = vsubq_s32(mul_00, mul_01);
            mul_0 = vmulq_s32(neon_vshuffleq_s32(c_1, c_1, 0, 3, 2, 1), sub_0);
        }

        int32x4_t mul_1;
        {
            int32x4_t mul_00 = vmulq_s32(neon_vshuffleq_s32(c_2, c_2, 2, 1, 0, 3), neon_vshuffleq_s32(c_3, c_3, 0, 3, 2, 1));
            int32x4_t mul_01 = vmulq_s32(neon_vshuffleq_s32(c_2, c_2, 0, 3, 2, 1), neon_vshuffleq_s32(c_3, c_3, 2, 1, 0, 3));
            int32x4_t sub_0 = vsubq_s32(mul_00, mul_01);
            mul_1 = vmulq_s32(neon_vshuffleq_s32(c_1, c_1, 1, 0, 3, 2), sub_0);
        }

        int32x4_t mul_2;
        {
            int32x4_t mul_00 = vmulq_s32(neon_vshuffleq_s32(c_2, c_2, 0, 3, 2, 1), neon_vshuffleq_s32(c_3, c_3, 1, 0, 3, 2));
            int32x4_t mul_01 = vmulq_s32(neon_vshuffleq_s32(c_2, c_2, 1, 0, 3, 2), neon_vshuffleq_s32(c_3, c_3, 0, 3, 2, 1));
            int32x4_t sub_0 = vsubq_s32(mul_00, mul_01);
            mul_2 = vmulq_s32(neon_vshuffleq_s32(c_1, c_1, 2, 1, 0, 3), sub_0);
        }

        int32x4_t mul_3 = vmulq_s32(c_0, vaddq_s32(vaddq_s32(mul_0, mul_1), mul_2)); 
        mul_3 = neon_vshuffleq_s32(mul_3, mul_3, 3, 1, 2, 0);
...
struct ktm::detail::mat_common_implement::inverse<4, float>
{
    ...
    static CHTHOLLY_INLINE M call(const M& m) noexcept
    {
        ...
        float32x4_t fac_0;
        {
            float32x4_t swp_0a = neon_vshuffleq_f32(c_3, c_2, 3, 3, 3, 3);
            float32x4_t swp_0b = neon_vshuffleq_f32(c_3, c_2, 2, 2, 2, 2);

            float32x4_t swp_00 = neon_vshuffleq_f32(c_2, c_1, 2, 2, 2, 2);
            float32x4_t swp_01 = neon_vshuffleq_f32(swp_0a, swp_0a, 2, 0, 0, 0);
            float32x4_t swp_02 = neon_vshuffleq_f32(swp_0b, swp_0b, 2, 0, 0, 0);
            float32x4_t swp_03 = neon_vshuffleq_f32(c_2, c_1, 3, 3, 3, 3);
        ...
        {
            float32x4_t swp_0a = neon_vshuffleq_f32(c_3, c_2, 3, 3, 3, 3);
            float32x4_t swp_0b = neon_vshuffleq_f32(c_3, c_2, 1, 1, 1, 1);

            float32x4_t swp_00 = neon_vshuffleq_f32(c_2, c_1, 1, 1, 1, 1);
            float32x4_t swp_01 = neon_vshuffleq_f32(swp_0a, swp_0a, 2, 0, 0, 0);
            float32x4_t swp_02 = neon_vshuffleq_f32(swp_0b, swp_0b, 2, 0, 0, 0);
            float32x4_t swp_03 = neon_vshuffleq_f32(c_2, c_1, 3, 3, 3, 3);
        ...
        float32x4_t fac_2;
        {
            float32x4_t swp_0a = neon_vshuffleq_f32(c_3, c_2, 2, 2, 2, 2);
            float32x4_t swp_0b = neon_vshuffleq_f32(c_3, c_2, 1, 1, 1, 1);

            float32x4_t swp_00 = neon_vshuffleq_f32(c_2, c_1, 1, 1, 1, 1);
            float32x4_t swp_01 = neon_vshuffleq_f32(swp_0a, swp_0a, 2, 0, 0, 0);
            float32x4_t swp_02 = neon_vshuffleq_f32(swp_0b, swp_0b, 2, 0, 0, 0);
            float32x4_t swp_03 = neon_vshuffleq_f32(c_2, c_1, 2, 2, 2, 2);
        ...
        {
            float32x4_t swp_0a = neon_vshuffleq_f32(c_3, c_2, 3, 3, 3, 3);
            float32x4_t swp_0b = neon_vshuffleq_f32(c_3, c_2, 0, 0, 0, 0);

            float32x4_t swp_00 = neon_vshuffleq_f32(c_2, c_1, 0, 0, 0, 0);
            float32x4_t swp_01 = neon_vshuffleq_f32(swp_0a, swp_0a, 2, 0, 0, 0);
            float32x4_t swp_02 = neon_vshuffleq_f32(swp_0b, swp_0b, 2, 0, 0, 0);
            float32x4_t swp_03 = neon_vshuffleq_f32(c_2, c_1, 3, 3, 3, 3);
        ...
        float32x4_t fac_5;
        {
            float32x4_t swp_0a = neon_vshuffleq_f32(c_3, c_2, 1, 1, 1, 1);
            float32x4_t swp_0b = neon_vshuffleq_f32(c_3, c_2, 0, 0, 0, 0);

            float32x4_t swp_00 = neon_vshuffleq_f32(c_2, c_1, 0, 0, 0, 0);
            float32x4_t swp_01 = neon_vshuffleq_f32(swp_0a, swp_0a, 2, 0, 0, 0);
            float32x4_t swp_02 = neon_vshuffleq_f32(swp_0b, swp_0b, 2, 0, 0, 0);
            float32x4_t swp_03 = neon_vshuffleq_f32(c_2, c_1, 1, 1, 1, 1);
        ...
        float32x4_t tmp_0 = neon_vshuffleq_f32(c_1, c_0, 0, 0, 0, 0);
        float32x4_t v_0 = neon_vshuffleq_f32(tmp_0, tmp_0, 2, 2, 2, 0);

        // v_0 = { m[1][1], m[0][1], m[0][1], m[0][1] }
        float32x4_t tmp_1 = neon_vshuffleq_f32(c_1, c_0, 1, 1, 1, 1);
        float32x4_t v_1 = neon_vshuffleq_f32(tmp_1, tmp_1, 2, 2, 2, 0);

        // v_0 = { m[1][2], m[0][2], m[0][2], m[0][2] }
        float32x4_t tmp_2 = neon_vshuffleq_f32(c_1, c_0, 2, 2, 2, 2);
        float32x4_t v_2 = neon_vshuffleq_f32(tmp_2, tmp_2, 2, 2, 2, 0);

        // v_0 = { m[1][3], m[0][3], m[0][3], m[0][3] }
        float32x4_t tmp_3 = neon_vshuffleq_f32(c_1, c_0, 3, 3, 3, 3);
        float32x4_t v_3 = neon_vshuffleq_f32(tmp_3, tmp_3, 2, 2, 2, 0);
        ...
        // + m[0][2] * Inverse[2][0]
        // + m[0][3] * Inverse[3][0];
        float32x4_t i_tmp_0 = neon_vshuffleq_f32(inv_0, inv_1, 0, 0, 0, 0);
        float32x4_t i_tmp_1 = neon_vshuffleq_f32(inv_2, inv_3, 0, 0, 0, 0);
        float32x4_t i_row_0 = neon_vshuffleq_f32(i_tmp_0, i_tmp_1, 3, 1, 3, 1);
        float32x4_t i_dot_0 = neon::vdotq_f32(c_0, i_row_0);
...
struct ktm::detail::mat_common_implement::determinant<3, float>
{
    ...
    static CHTHOLLY_INLINE float call(const M& m) noexcept
    {
        ...
        return intrin::dot_cvt_f32<3>(c_0, sub_0); 
    }
};
...
struct ktm::detail::mat_common_implement::inverse<4, float>
{
    ...
    static CHTHOLLY_INLINE M call(const M& m) noexcept
    {
        ...
        __m128 i_dot = intrin::dot_ps(c_0, i_row_0);
...
struct ktm::detail::mat_common_implement::determinant<3, int>
{
    ...
    static CHTHOLLY_INLINE float call(const M& m) noexcept
    {
        ...
        return intrin::dot_cvt_si32<3>(c_0, sub_0); 
    }
};
