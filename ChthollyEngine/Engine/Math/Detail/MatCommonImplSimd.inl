...
struct ktm::detail::mat_common_implement::transpose<ktm::mat<N, N, std::enable_if_t<N == 3 || N == 4, float>>>
{
    ...
    static CHTHOLLY_INLINE RetM call(const M& m) noexcept
    {
        if constexpr(N == 3)
        {
            ...
            float32x4_t ret2 = __builtin_shufflevector(tmp1, c_2, 0, 2, 4, 7);
...
struct ktm::detail::mat_common_implement::transpose<ktm::mat<N, N, std::enable_if_t<N == 3 || N == 4, int>>>
{
    ...
    static CHTHOLLY_INLINE RetM call(const M& m) noexcept
    {
        if constexpr(N == 3)
        {
            int32x4_t c_0 = vld1q_s32(reinterpret_cast<const int*>(&reinterpret_cast<const ColT*>(&m)[0]));
            int32x4_t c_1 = vld1q_s32(reinterpret_cast<const int*>(&reinterpret_cast<const ColT*>(&m)[1]));
            int32x4_t c_2 = vld1q_s32(reinterpret_cast<const int*>(&reinterpret_cast<const ColT*>(&m)[2]));
            ...
            RetM ret;
            vst1q_s32(reinterpret_cast<int*>(&reinterpret_cast<RawT*>(&ret)[0]), ret0);
            vst1q_s32(reinterpret_cast<int*>(&reinterpret_cast<RawT*>(&ret)[1]), ret1);
            vst1q_s32(reinterpret_cast<int*>(&reinterpret_cast<RawT*>(&ret)[2]), ret2);
            return ret; 
        }
        else
        {
            ...
            int32x4_t c_1 = vld1q_s32(reinterpret_cast<const int*>(&reinterpret_cast<const ColT*>(&m)[1]));
            int32x4_t c_2 = vld1q_s32(reinterpret_cast<const int*>(&reinterpret_cast<const ColT*>(&m)[2]));
            int32x4_t c_3 = vld1q_s32(reinterpret_cast<const int*>(&reinterpret_cast<const ColT*>(&m)[3]));
            ...
            vst1q_s32(reinterpret_cast<int*>(&reinterpret_cast<RawT*>(&ret)[1]), ret1);
            vst1q_s32(reinterpret_cast<int*>(&reinterpret_cast<RawT*>(&ret)[2]), ret2);
            vst1q_s32(reinterpret_cast<int*>(&reinterpret_cast<RawT*>(&ret)[3]), ret3);
            return ret;
        }
    }
};
...
struct ktm::detail::mat_common_implement::transpose<ktm::mat<N, N, std::enable_if_t<N == 3 || N == 4, unsigned int>>>
{
    ...
    static CHTHOLLY_INLINE RetM call(const M& m) noexcept
    {
        if constexpr(N == 3)
        {
            uint32x4_t c_0 = vld1q_u32(reinterpret_cast<const unsigned int*>(&reinterpret_cast<const ColT*>(&m)[0]));
            uint32x4_t c_1 = vld1q_u32(reinterpret_cast<const unsigned int*>(&reinterpret_cast<const ColT*>(&m)[1]));
            uint32x4_t c_2 = vld1q_u32(reinterpret_cast<const unsigned int*>(&reinterpret_cast<const ColT*>(&m)[2]));
            ...
            RetM ret;
            vst1q_u32(reinterpret_cast<unsigned int*>(&reinterpret_cast<RawT*>(&ret)[0]), ret0);
            vst1q_u32(reinterpret_cast<unsigned int*>(&reinterpret_cast<RawT*>(&ret)[1]), ret1);
            vst1q_u32(reinterpret_cast<unsigned int*>(&reinterpret_cast<RawT*>(&ret)[2]), ret2);
            return ret; 
        }
        else
        {
            ...
            uint32x4_t c_1 = vld1q_u32(reinterpret_cast<const unsigned int*>(&reinterpret_cast<const ColT*>(&m)[1]));
            uint32x4_t c_2 = vld1q_u32(reinterpret_cast<const unsigned int*>(&reinterpret_cast<const ColT*>(&m)[2]));
            uint32x4_t c_3 = vld1q_u32(reinterpret_cast<const unsigned int*>(&reinterpret_cast<const ColT*>(&m)[3]));
            ...
            vst1q_u32(reinterpret_cast<unsigned int*>(&reinterpret_cast<RawT*>(&ret)[1]), ret1);
            vst1q_u32(reinterpret_cast<unsigned int*>(&reinterpret_cast<RawT*>(&ret)[2]), ret2);
            vst1q_u32(reinterpret_cast<unsigned int*>(&reinterpret_cast<RawT*>(&ret)[3]), ret3);
            return ret;
        }
    }
};
